Code Review (CR) Comments (Pihu)
1. **Fixed** Implemented password hashing with argon2
2. **Fixed** Added more robust login endpoint and all endpoints now rely on login token rather than just user id
...
Code Review (CR) Comments (Angel)
1. **Fixed** See Pihu CR#1
2. **Skipped** Duplicate accounts are alraedy prevented and inputs are validated
3. **Fixed** See Pihu CR#5 and Nicolas SAPI #12
4. **Fixed** See Nicolas CR#1
5. **Fixed** See Pihu CR#2
6. **Fixed** See Pihu CR#6
7. **Skipped** This endpoint updates movies and returns the movie. Get collection should limit because you want to see all the movies you have added.
8. **Fixed** See Pihu CR#6
